        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex flex-col items-center mt-6">
                    ...
                    onclick="alert('Untuk reset password, silakan hubungi Pimpinan atau Admin IT.')" 
                    class="mt-4 text-sm text-gray-600 hover:text-indigo-600 transition duration-150 underline decoration-dotted">
                        Lupa Password?
                    </a>
                </div>
            </form>
